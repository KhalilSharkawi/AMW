...
namespace WebSite.API
{
    ...
    public class AccountController : ApiController
    {
        ...
        //[Route("all")]
        [HttpPost]
        public Response<List<UserProfile>> all()
        {
        ...
        //[Route("one")]
        [HttpPost]
        public Response<UserProfile> one(int id)
        {
        ...
        [HttpPost]
        //[Route("edit")]
        public Response<UserProfile> edit([FromBody]UserProfile UserProfile)
        {
        ...
        //[Route("create")]
        [HttpPost]
        public Response<UserProfile> create([FromBody]UserProfile UserProfile)
        {
            if (!ModelState.IsValid)
            {
                return new Response<UserProfile>("Bad Request", null, "Bad Request", -2);
        ...
        [HttpPost]
        //[Route("delete")]
        public Response<UserProfile> delete([FromBody]UserProfile reg)
        {
