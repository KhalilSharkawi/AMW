...
public class AVLoadingIndicatorView extends View {
    ...
    public void setIndicator(Indicator d) {
        if (mIndicator != d) {
            ...
            mIndicator = d;
            //need to set indicator color_switch again if you didn't specified when you update the indicator .
     ...
     * setIndicatorColor(0xFF00FF00)
     * or
     * setIndicatorColor(getResources().getColor(android.R.color_switch.black))
     * @param color
     */
