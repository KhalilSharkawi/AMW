//package com.MS.applications.UnlimitedServicesDriver.MyActivities.dummy;
//
...
//     */
//    public static final List<Customer> ITEMS = new ArrayList<>();
//
//    /**
//     * A map of sample (dummy) items, by ID.
//     */
//    public static final Map<String, Customer> ITEM_MAP = new HashMap<>();
//
